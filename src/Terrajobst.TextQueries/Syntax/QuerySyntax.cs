...
using Terrajobst.TextQueries;
using Terrajobst.TextQueries.Syntax;

namespace TheGreatAudit.Data.Querying.Syntax;

public abstract partial class QuerySyntax : QueryNodeOrToken
{
    private protected QuerySyntax()
    {
    }
    ...
    public static QuerySyntax Parse(string text, out ImmutableArray<Diagnostic> diagnostics)
    {
        ThrowIfNull(text);
